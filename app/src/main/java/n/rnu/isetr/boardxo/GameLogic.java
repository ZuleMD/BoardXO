...
class GameLogic {
    ...
    String[] playerNames = {"Player X", "Player O"};
    ...
    public boolean winnerCheck(){
        ...
        if (isWinner || boardFilled == 9) {
            animator = ObjectAnimator.ofFloat(playerTurn, "alpha", 1.0f, 0.0f, 1.0f);
        ...
        if (isWinner){
            playAgainBTN.setVisibility(View.VISIBLE);
             playerTurn.setText((playerNames[player-1] + " won! :D"));
            return true;
        }
